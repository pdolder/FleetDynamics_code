predict_ensemble <- function(train.data = train.data, model_predictions = model_preditions, type = "ensemble_dirichlet", train.yrs = train.yrs, test.yrs = test.yrs, Closure = Closure) {
